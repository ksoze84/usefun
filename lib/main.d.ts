 ...
 *
 */
export declare const noSet: <P>(returnValue?: P) => P;
 ...
 */
export declare function useFun<T, Q extends Record<string, any>>(fun: FunObject<T, Q> | (() => FunObject<T, Q>)): Readonly<[T, Omit<Q, 'state'>]>;
/**
 ...
 */
export declare function useFun<T, S, Q extends Record<string, any>>(fun: FunObject<T, Q> | (() => FunObject<T, Q>), select: (state: T) => S): Readonly<[S, Q]>;
export {};
